...
const ChangePasswordForm = ({
    ...
    const {
        ...
        user?.id ? route("admin.users.updatePassword",user.id) : route("admin.password.update")
    );
    useEffect(() => {
        reset();
    }, []);
    ...
    return (
        <Dialog open={open} onClose={onClose}>
            ...
            <DialogContent>
                <Box component="form" onSubmit={handleSubmit} method="post" action={ route("admin.password.update")}
                     sx={{pt: "1em"}}>
